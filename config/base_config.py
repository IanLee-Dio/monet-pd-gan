...
class BaseConfig:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument(
            "--gt_root",
            type=str,
            default="/Users/dio/works/pythons/monet-pd-gan/images",
            help="path to detail images (which are the groundtruth)",
        )
        parser.add_argument(
            "--mask_root",
            type=str,
            default="/Users/dio/works/pythons/monet-pd-gan/thresh.jpg",
        ...
        parser.add_argument(
            ...
            "--gpu_ids", type=str, default="-1", help="gpu ids: e.g. 0  0,1,2, 0,2"
        ...
        parser.add_argument(
            "--pre_ckpt_PConv_EN_dir", default="/Users/dio/works/pythons/monet-pd-gan/pre_trained/checkpoints/PConv-Training/50_net_EN.pth", type=str, help="max image size"
        )
        parser.add_argument(
            "--pre_ckpt_PConv_DE_dir", default="/Users/dio/works/pythons/monet-pd-gan/pre_trained/painting/DEModel.pth", type=str, help="max image size"
        )
